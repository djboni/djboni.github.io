...
#     VERSION:	1.0.1
#    MODIFIED:  D.A. Boni (djboni@gmail.com)
#     VERSION:  1.0.1-0
...
## Smaller filename ($filen)
filen=$(echo $filen | sed 's/10/A/g;s/11/B/g;s/12/C/g;s/\([2-9A-C]\)-/\1/g')
...
mkdir -p svg pdf png mid mp3 mp4

## create SVG
abcm2ps "$filen.abc" -O "svg/$filen.svg" -g
mv "svg/${filen}"*".svg" "svg/$filen.svg"

## create PDF
inkscape --file="svg/$filen.svg" --export-area-drawing --without-gui --export-pdf="pdf/$filen.pdf"
#inkscape "svg/$filen.svg" --export-area-drawing --batch-process --export-type=pdf --export-filename="pdf/$filen.pdf"

## create PNG
inkscape --file="svg/$filen.svg" --export-area-drawing --without-gui --export-png="png/$filen.png"
#inkscape "svg/$filen.svg" --export-area-drawing --batch-process --export-type=pdf --export-filename="png/$filen.png"

## create MIDI
abc2midi "$filen.abc" -quiet -silent -o "mid/$filen.mid"

## create MP3
sh MIDI-para-MP3.sh "mid/$filen.mid" "mp3/$filen.mp3"
...
#RESOLUTION="640 360"
RESOLUTION="320 180"
sh MIDI-para-MP4.sh "mid/$filen.mid" "mp4/$filen.mp4" $RESOLUTION
